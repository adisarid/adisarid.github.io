...
author: "Adi Sarid"
date: 2019-08-30T12:00:00-00:00
categories: ["R"]
tags: ["Shiny", "AWS", "Cognito", "Authentication"]
---
...
This process description was a very simplified, down-to-earth, nutshell description of oauth2. It might be inaccurate, but it will be enough for our goal here which is to actually implement it within a shiny app, integrating to Cognito. If you wish, you can find more information about oauth2 in detail [here](https://www.digitalocean.com/community/tutorials/an-introduction-to-oauth-2).

Let's get to business.

## Step 1: Define a user pool

This step is actually performed within the AWS Console. Log into your AWS console and find the Cognito service.
Click on "Manage User Pools", and then create a new user pool. The step-by-step wizard is pretty self explanatory, so I'll focus on the important things:
...
![](/media/aws_app_client_settings.jpg)
